...
if(isset($_POST['guardar'])) {
  ...
  SET nombre='$nombre',descripcion='$desc',categoria='$categoria',subcategoria='$subcategoria',unidad='$unidad',precio='$precio',cantidad='$cantidad',imagen='$imagen'
  WHERE id = $id";
                      ...
                      ?>
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal" id="guardar" name="guardar">
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" id="nombre" name="nombre" value = "<?php echo"$nombre ";?>" placeholder="nombre" class="form-control" min="3" maxlength="20" required><small class="form-text text-muted">Introduce el nombre del elemento</small></div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Descripcion</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="desc" name="desc" placeholder="descripcion" value = "<?php echo"$desc ";?>" class="form-control"><small class="form-text text-muted" maxlength="50" required>Introduce una breve descripcion</small></div>
                          </div>
                          <div class="row form-group">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="number" id="precio" value = "<?php echo"$precio";?>" name="precio" placeholder="precio" class="form-control"><small class="form-text text-muted" min="0.01" max="9999999" step="0.01" required>Introduce el precio de venta</small></div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Cantidad</label></div>
                            <div class="col-12 col-md-9"><input type="number" id="cantidad" name="cantidad" value ="<?php echo"$cantidad";?>" placeholder="cantidad" class="form-control"><small class="form-text text-muted" min="0" max="9999999" step="1" required>Introduce la cantidad en stock</small></div>
                          </div>     
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Url de imagen</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="imagen" name="imagen" value = "<?php echo"$imagen ";?>" placeholder="http://" class="form-control"><small class="form-text text-muted" >Introduce el link a la imagen</small></div>
                          </div>                          
