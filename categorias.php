...
if(isset($_POST['guardar'])) {
    ...
    if ($DBcon->query($query)) {
      $msg = "<div class='alert alert-success'>
         <span class='glyphicon glyphicon-info-sign'></span> &nbsp; Elemento guardado correctamente <a href=categorias.php>  Actualizar</a>.
        </div>";
     }else {
...
if(isset($_POST['eliminar'])) {
    ...
    if ($DBcon->query($query)) {
      $msg_eliminar = "<div class='alert alert-success'>
         <span class='glyphicon glyphicon-info-sign'></span> &nbsp; categoria eliminada correctamente <a href=categorias.php>  Actualizar</a>.
        </div>";
     }else {
                    ...
                    <div class="card">
                        ...
                        <?php
                          ...
                          <?php
                                    ...
                                    echo"<td><a href='modificar-cat.php?id=$id' class='btn btn-info' role='button' ><center>Modificar</center></a></td>";
                                    echo"
                    ...
                    <div class="card">
                        ...
                        <?php
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" maxlength="20" id="nombre" name="nombre" placeholder="nombre" class="form-control" min="3" maxlength="20" required><small class="form-text text-muted">Introduce el nombre del elemento</small></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">Descripcion</label></div>
                                <div class="col-12 col-md-9"><input type="text"   id="desc" name="desc" placeholder="descripcion" class="form-control" maxlength="100" required><small class="form-text text-muted">Introduce una breve descripcion</small></div>
                            </div>
